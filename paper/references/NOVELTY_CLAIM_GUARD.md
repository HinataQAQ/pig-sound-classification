...
- AudioProtoPNet: a frozen-representation prototype head and retrieval of similar training examples, but flat bird-species classification.
...
- B3−B1: cumulative delta `0.006749`, unadjusted `p=0.013809`; it does not prove that either hierarchy or prototype increments are independently significant, and it does not survive Bonferroni correction across the five planned contrasts at `alpha=0.01`.
