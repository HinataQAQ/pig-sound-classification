...
def main():
    ...
    configs = [
        ...
        (
            f"logmel_dur2_hier_{weight_tag}",
            f"cv5_expanded_cap3x_fold*_logmel_dur2_hier_{weight_tag}_seed*/summary.json",
        ),
    ]
    ...
    out = REPORTS / f"hier_longcontext_confusion_summary_{weight_tag}.csv"
